...
const newCycleFormValidationSchema = zod.object({
  ...
  minutesAmount: zod
    .number()
    .min(5, 'Precisa ser de no minimo 5 minutos.')
    .max(60, 'O intervalo precisa de no máximo 60 minutos.'),
})
...
export function Home() {
  ...
  const totalSeconds = ativeCycle ? ativeCycle.minutesAmount * 60 : 0
  const currentSeconds = ativeCycle ? totalSeconds - amoutSecondsPassed : 0
  ...
  return (
    <HomeContainer>
      <form onSubmit={handleSubmit(hadleCreateNewCycle)} action="">
        ...
        {ativeCycle ? (
          <StopCountdownButton onClick={hanleInterruptCycle} type="button">
            <HandPalm size={24} />
            Interromper
          </StopCountdownButton>
        ) : (
